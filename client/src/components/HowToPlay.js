  ...
  return(
    <div className='home-body'>
      ...
      <div className='howtoplay'>
        ...
        ---
        <p>Avocados will pop up in each of the nine holes and will need to be whacked as quickly as you can. Over time, you'll be able to buy items that you can equip and use in the game to whack those avocados more efficiently. Items can boost your attack, defense, and health stats, making you a very powerful chef.</p>
        ---
